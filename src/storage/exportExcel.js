...
const SHEET_COLUMNS = {
  ...
  pages: [
    ...
    { header: "Has Product Availability", value: (row) => boolText(row.schema?.hasProductAvailability) },
    { header: "Has Product Brand", value: (row) => boolText(row.schema?.hasProductBrand) },
