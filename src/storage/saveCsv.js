...
const COLUMNS = [
  ...
  { header: "Faceted URL", value: (row) => row.isFacetedUrl },
  { header: "Facet Query Params", value: (row) => row.facetQueryParams?.join(", ") },
  ...
  { header: "Found Expected Schema Types", value: (row) => row.schemaValidation?.foundSchema?.join(", ") },
  { header: "Expected Schema Status", value: (row) => row.schemaValidation?.status },
  { header: "Schema Issues", value: (row) => row.schemaIssues?.join(", ") },
  ...
  { header: "Invalid Schema Structure Count", value: (row) => row.schema?.invalidStructureCount },
  { header: "Has Article Schema", value: (row) => row.schema?.hasArticleSchema },
  { header: "Has Article Author", value: (row) => row.schema?.hasArticleAuthor },
  { header: "Has Article Published Date", value: (row) => row.schema?.hasArticlePublishedDate },
  { header: "Has Product Schema", value: (row) => row.schema?.hasProductSchema },
  { header: "Has Product Price", value: (row) => row.schema?.hasProductPrice },
  { header: "Has Product Availability", value: (row) => row.schema?.hasProductAvailability },
  { header: "Has Product Brand", value: (row) => row.schema?.hasProductBrand },
  { header: "Has Product Rating", value: (row) => row.schema?.hasProductRating },
  ...
  { header: "Ecommerce Signals", value: (row) => row.wordpress?.ecommerceSignals?.join(", ") },
